...
/* ESERCIZIO 2
  ...
  */ for (let i = 0; i < starWarsCharacters.length; i++) {
  const charactersNames = starWarsCharacters[i].name;
  charactersNamesArray.push(charactersNames);
}
console.log("charactersNamesArray", charactersNamesArray);

/* ESERCIZIO 3
    Seguendo i passaggi precedenti crea un nuovo array chiamato "femaleCharacters" e inserisci al suo interno tutti gli oggetti femminili.
  */ const femaleCharactersArray = [];
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "female") {
    femaleCharactersArray.push(starWarsCharacters[i]);
  }
}
console.log("femaleCharactersArray", femaleCharactersArray);
